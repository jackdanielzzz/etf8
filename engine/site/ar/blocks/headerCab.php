...
if (!$currentUser) {
    echo 'خطأ في استرداد بيانات المستخدم';
    exit;
}
            ...
            <div class="content">
                <div class="headerAccount-content">
                                ...
                                <div class="content">
                                    <div class="sideBar-content2">
                                        ...
                                        <div class="setting">
                                            ...
                                            <a href="/ar/account/deals" class="setting-item">
                                            ...
                                            <a href="/ar/account/team" class="setting-item">
                                            ...
                                            <a href="/ar/account/promo" class="setting-item">
                                            ...
                                            <a href="/ar/account/rix" class="setting-item">
                    ...
                    <div class="headerAccount-right">
                        <div class="headerAccount-menu d-lg-flex d-none">
                            <div class="headerAccount-menu_item">
                                ...
                                <div class="headerAccount-menu_link">
                                    <a href="#" data-toggle="modal" data-target="#arbitration">توقيع عقد ETF</a>
                                </div>
                            </div>
                            ...
                            <div class="headerAccount-menu_item">
                                ...
                                <div class="headerAccount-menu_link">
                                    <a href="#" class="disabled_link">عمادا</a>
                                </div>
                            </div>
                        ...
                        <a href="/ar/account/profile" class="headerAccount-avatar d-lg-flex d-none">
                                            ...
                                            <div class="accountBar">
                                                ...
                                                <div class="accountBar-form">
                                                    <form id="profileForm" autocomplete="off">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="profile-label">كلمة المرور الخاصة بك<br><small>(اترك فارغا - سيبقى نفس الشيء)</small></label>
