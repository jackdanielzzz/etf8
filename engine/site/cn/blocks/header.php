                ...
                <div class="header-content">
                    ...
                    <div class="desktopMenu d-lg-block d-none">
                        <ul class="desktopMenu-ul">
                            <li class="desktopMenu-li <?= isActiveTab('/cn') ? "desktopMenu_active" : "" ?>">
                                <a href="/cn">家</a>
                            </li>
                            <li class="desktopMenu-li <?= isActiveTab('/cn/affiliate') ? "desktopMenu_active" : "" ?>">
                                <a href="/cn/affiliate">对于合作伙伴</a>
                            </li>
                            <li class="desktopMenu-li <?= isActiveTab('/cn/about') ? "desktopMenu_active" : "" ?>">
                                <a href="/cn/about">关于我们</a>
                            </li>
                            <li class="desktopMenu-li <?= isActiveTab('/cn/faq') ? "desktopMenu_active" : "" ?>">
                                <a href="/cn/faq">FAQ</a>
                            </li>

                            <li class="desktopMenu-li <?= isActiveTab('/cn/tokenization') ? "desktopMenu_active" : "" ?>">
                                <a href="/cn/tokenization">资产代币化</a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div class="sideBar-content">
                                            <div class="content">
                                                ...
                                                <div class="menu">
                                                    <ul class="menu-ul">
                                                        <li class="menu-li">
                                                            <a href="/cn" class="menu-a <?= isActiveTab('/cn') ? "menu_active" : "" ?>">家</a>
                                                        </li>
                                                        <li class="menu-li">
                                                            <a href="/cn/affiliate" class="menu-a <?= isActiveTab('/cn/affiliate') ? "menu_active" : "" ?>">对于合作伙伴</a>
                                                        </li>
                                                        <li class="menu-li">
                                                            <a href="/cn/about" class="menu-a <?= isActiveTab('/cn/about') ? "menu_active" : "" ?>">关于我们</a>
                                                        </li>
                                                        <li class="menu-li">
                                                            <a href="/cn/faq" class="menu-a <?= isActiveTab('/cn/faq') ? "menu_active" : "" ?>">FAQ</a>
                                                        </li>

                                                        <li class="menu-li">
                                                            <a href="/cn/tokenization <?= isActiveTab('/cn/tokenization') ? "menu_active" : "" ?>" class="menu-a">资产代币化</a>
                                                        </li>
                                                    </ul>
                                                </div>
