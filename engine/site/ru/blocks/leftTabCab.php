<div class="nav flex-column nav-pills me-3 tabs-left" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a href="/ru/account/deals" class="nav-link <?= isActiveTab('/ru/account/deals') ? "active" : "" ?>">
    ...
    <a href="/ru/account/team" class="nav-link <?= isActiveTab('/ru/account/team') ? "active" : "" ?>">
        <span class="tabsLeft">
            <span class="tabsLeft-top">
                <span class="tabsLeft-top_left">
                    <span class="tabsLeft-top_icon">
    ...
    <a href="/ru/account/promo" class="nav-link <?= isActiveTab('/ru/account/promo') ? "active" : "" ?>">
        <span class="tabsLeft">
            <span class="tabsLeft-top">
                <span class="tabsLeft-top_left">
                    <span class="tabsLeft-top_icon">
    ...
    <a href="/ru/account/rix" class="nav-link nav-link_height <?= isActiveTab('/ru/account/rix') ? "active" : "" ?>">
        <span class="tabsLeft">
            <span class="tabsLeft-top">
                <span class="tabsLeft-top_left">
                    <span class="tabsLeft-top_icon">
