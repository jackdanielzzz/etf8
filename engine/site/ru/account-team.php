                            ...
                            <div class="tabs-2">
                                ...
                                <div class="tabs-2_top">
                                    ...
                                    <div class="tabs-2_item">
                                        <?php
                                        /** @var $currentUser */
                                        $userInputs = getAmountInputsByUserId($currentUser['uid']);
                                        $userOutputs = getAmountOutputsByUserId($currentUser['uid']);
                                        $userTariffLevel = getTariffLevelId($currentUser['rating']);
                                        $s3 = 10;
                                        if ($userTariffLevel < $s3) {
                                            $modifiedInput = $userInputs - $userOutputs/5;
                                        } else {
                                            $modifiedInput = $userInputs;
                                        }

                                        ?>
                                        <h5>Команда</h5>
                                        <h4>Партнеров: <?= $isVirtual ? $currentUser['v_total_partners'] + $recursiveReferralsCount : $recursiveReferralsCount  ?></h4>
                                        <p style="margin-bottom: 0px;margin-top: 18px;">Индивидуальный депозит: <?= moneyFormat($modifiedInput) ?> USDT</p>
                                        <p>Реферальный бонус от дохода структуры: <span><?= $currentUser['rating_bonus'] ?></span></p>
                                        <p style="margin-bottom: 0px">Всего заработано: <?= moneyFormat($totalTeamAccrued) ?> USDT</p>
                                    </div>
                                    ...
                                    <div class="totalClose d-none">
                                        ...
                                        <div class="totalClose-text"><p>Поздравляем, вы перешли на следующий уровень <span id="newLevel">L1</span> и заработали <span id="earnedUsdt">50</span> USDT</p></div>
                                ...
                                <div class="tabs-2_center">
                                    ...
                                    <div class="tabs-2_centerTop">
                                        ...
                                        <div class="tabs-2_centerItem" >
                                            <p>Текущая квалификация: <span><?= $currentUser['rating'] ?></span></p>
                                        </div>

                                        <div class="tabs-2_bottomBlock">
                                            <div class="tabs-2_bottomItem">
                                                <p>Активные партнеры:</p>
...
<!--                                            </div>-->
                                    ...
                                    <div class="tabs-2_centerBottom">
                                        ...
                                        <div class="tabs-2_bottomTitle">
                                            ...
                                            ?>
                                            <h5>Условия для повышения квалификации до: <span><?= $nextLevel['lvl'] ?></span></h5>
                                    ...
                                    <div class="tabs-2__conditions">
                                        ...
                                        <p>Ваш реферальный код: <?= $currentUser['activation'] ?></p>
                                    </div>
