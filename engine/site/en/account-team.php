                            ...
                            <div class="tabs-2">
                                ...
                                <div class="tabs-2_top">
                                    ...
                                    <div class="tabs-2_item">
                                        ...
                                        ?>
                                        <h5>Team</h5>
                                        <h4>Number of partners: <?= $isVirtual ? $currentUser['v_total_partners'] + $recursiveReferralsCount : $recursiveReferralsCount  ?></h4>
                                        <p style="margin-bottom: 0px;margin-top: 18px;">Individual deposit: <?= $userInputs ?> USDT</p>
                                        <p>Referral bonus from structure income: <span><?= $currentUser['rating_bonus'] ?></span></p>
                                        <p style="margin-bottom: 0px">Total earned: <?= moneyFormat($totalTeamAccrued) ?> USDT</p>
                                    </div>
                                    ...
                                    <div class="totalClose d-none">
                                        ...
                                        <div class="totalClose-text"><p>Congratulations, you have moved to the next level <span id="newLevel">L1</span> and earned<span id="earnedUsdt">50</span> USDT</p></div>
                                ...
                                <div class="tabs-2_center">
                                    ...
                                    <div class="tabs-2_centerTop">
                                        ...
                                        <div class="tabs-2_centerItem" >
                                            <p>Current qualification: <span><?= $currentUser['rating'] ?></span></p>
                                        </div>
...
<!--                                            </div>-->
                                    ...
                                    <div class="tabs-2_centerBottom">
                                        ...
                                        <div class="tabs-2_bottomTitle">
                                            ...
                                            ?>
                                            <h5>Conditions for advanced training up to: <span><?= $nextLevel['lvl'] ?></span></h5>
                                    ...
                                    <div class="tabs-2__conditions">
                                        ...
                                        <p>Your referral code: <?= $currentUser['activation'] ?></p>
                                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btn.addEventListener('click', async e => {
        ...
        try {
            ...
            if (json.success) {
                titleEl.textContent = 'The transaction is done';
                msgEl.textContent   = `Transferred ${moneyFormat(json.amount)} USDT to the main balance`;
            } else if (json.error === 'nothing_to_transfer') {
                titleEl.textContent = 'Nothing to transfer';
                msgEl.textContent   = 'Team balance is 0';
            } else {
