            ...
            <div class="content">
                <div class="headerAccount-content">
                                    ...
                                    <div class="sideBar-content2">
                                        ...
                                        <div class="setting-link">
                                            ...
                                            <a href="#" class="setting-link_item">
                                                ...
                                                <div class="setting-link_text">
                                                    <p class="disabled_link">Staking</p>
                                                </div>
                                            </a>
                                        ...
                                        <div class="setting">
                                            ...
                                            <a href="/en/account/deals" class="setting-item">
                                            ...
                                            <a href="/en/account/team" class="setting-item">
                                            ...
                                            <a href="/en/account/promo" class="setting-item">
                                            ...
                                            <a href="/en/account/rix" class="setting-item">
                    ...
                    <div class="headerAccount-right">
                        <div class="headerAccount-menu d-lg-flex d-none">
                            <div class="headerAccount-menu_item">
                                ...
                                <div class="headerAccount-menu_link">
                                    <a href="#" data-toggle="modal" data-target="#arbitration">Sign an ETF contract</a>
                                </div>
                            </div>
                            ...
                            <div class="headerAccount-menu_item">
                                ...
                                <div class="headerAccount-menu_link">
                                    <a href="#" class="disabled_link">Staking</a>
                                </div>
                            </div>
                        ...
                        <a href="/en/account/profile" class="headerAccount-avatar d-lg-flex d-none">
                                            ...
                                            <div class="accountBar">
                                                ...
                                                <div class="accountBar-form">
                                                    <form id="profileForm" autocomplete="off">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="profile-label">Your last name</label>
                                                            <input type="text"
                                                                   class="form-control"
                                                                   name="sur_name"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="profile-label">Your phone number</label>
                                                            <input type="tel"
                                                                   class="form-control"
                                                                   name="phone"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="profile-label">Your password<br><small>(Leave it blank and the old one will remain)</small></label>
                                                    ...
                                                    <div class="accountBar-state_bottom">
                                                        ...
                                                        <div class="accountBar-state_item">
                                                            ...
                                                            <div class="accountBar-item_text">
                                                                ...
                                                                <span><?= $currentUser['verified'] == 1 ? 'Verified' : 'Not verified'?></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="accountBar-state_item">
                                                            ...
                                                            <div class="accountBar-item_text">
                                                                <a href="/logout" class="state_a">Logout</a>
                                                            </div>
                                                        </div>
                                                    </div>
