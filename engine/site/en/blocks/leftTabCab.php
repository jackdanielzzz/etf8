<div class="nav flex-column nav-pills me-3 tabs-left" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a href="/en/account/deals" class="nav-link <?= isActiveTab('/en/account/deals') ? "active" : "" ?>">
    ...
    <a href="/en/account/team" class="nav-link <?= isActiveTab('/en/account/team') ? "active" : "" ?>">
        <span class="tabsLeft">
            <span class="tabsLeft-top">
                <span class="tabsLeft-top_left">
                    <span class="tabsLeft-top_icon">
    ...
    <a href="/en/account/promo" class="nav-link <?= isActiveTab('/en/account/promo') ? "active" : "" ?>">
        <span class="tabsLeft">
            <span class="tabsLeft-top">
                <span class="tabsLeft-top_left">
                    <span class="tabsLeft-top_icon">
    ...
    <a href="/en/account/rix" class="nav-link nav-link_height <?= isActiveTab('/en/account/rix') ? "active" : "" ?>">
        <span class="tabsLeft">
            <span class="tabsLeft-top">
                <span class="tabsLeft-top_left">
                    <span class="tabsLeft-top_icon">
    ...
    <a href="/userfiles/etfrix.apk" class="nav-link">
        <img src="/img/etfrix-apk.png" style="margin-top: -15px">
    </a>
